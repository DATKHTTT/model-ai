...
def split_train_test_data():
    ...
    img_files = glob('./datasets/**/**/**/*.jpg') + glob('./datasets/**/**/**/*.png')
    ...
    train_x, val_x, train_y, val_y = train_test_split(img_files, labels, test_size=0.2, random_state=42)
...
if __name__ == "__main__":
    # make_data_classification_from_yolo_format()
    ...
    # for i in range(10):
    #     print(train_x[i], num2label[train_y[i]])
